...
admin.site.register(Case, list_display = ('id', 'title', 'value', 'staffer', 'current_status', 'current_step', 'current_step_user', 'current_step_due_date', 'next_step', 'next_step_user', 'planning', 'bidding', 'approval', 'contracting'))
