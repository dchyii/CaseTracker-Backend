...
admin.site.register(Case, list_display = ('id', 'title', 'value', 'folder_link', 'staffer', 'need_by_date'))
admin.site.register(Step, list_display = ('id', 'case', 'stage', 'step', 'staffer', 'res_party', 'stage_deadline', 'completed_date'))
